...
global.youtube = 'https://youtube.com/@lukiWell'
global.ig = 'https://instagram.com/lukyyokeyy?igshid=ZDdkNTZiNTM='
...
//—————「 Set Nama Own & Bot 」—————//
global.nomerOwner = "62895347158464" //Bebas ganti 
global.namaOwner = "亗 LUKYY 𝟏𝐒" //Bebas ganti
global.footer = '亗 LUKYY 𝟏𝐒' //ubah jadi nama mu, note tanda ' gausah di hapus!
//=================================================//
global.packname = '亗 LUKYY 𝟏𝐒'
global.ownerr = ['亗 LUKYY 𝟏𝐒']
global.author = '[亗 LUKYY 𝟏𝐒]'
global.prefa = ['','!','.',',','🐤','🗿']
global.sp = '⭔'
global.mess = {
    wait: '⏳ _*Loading...*_',
